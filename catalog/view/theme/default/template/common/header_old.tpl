...
<div class="links">
                         <!--link1-->   
                <?php foreach ($informations as $information) { if ($information['information_id']=='4') {?>
                   
                   <?
                $url_my="http://".$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'];
                $url_now= $information['href'];
                if (($url_my == $url_now)) {
                
                ?>
                   <a href="<?php echo  $information['href']; ?>"class="selected" ><span><?php echo $information['title']; ?></span></a>
                  <?
                  }else
                  {
                  ?>
                   <a href="<?php echo $information['href']; ?>" ><span><?php echo $information['title']; ?></span></a>
                ...
                <!--!link1-->
                        ...
                        <!--link1-->   
                <?php foreach ($informations as $information) { if ($information['information_id']=='6') {?>
                ...
                ?>
                   <a href="<?php echo  $information['href']; ?>"class="selected border" ><span><?php echo $information['title']; ?></span></a>
                  <?
                  }else
                  {
                  ?>
                   <a href="<?php echo $information['href']; ?>" class="border" ><span><?php echo $information['title']; ?></span></a>
                  ...
                  ?>  
                      ...
                      <?php }} ?>
                <!--!link1-->
                         <a href="<?php echo $special; ?>" class="BgRed"><span>Акции</span></a>
                   <!--link1-->   
                <?php foreach ($informations as $information) { if ($information['information_id']=='7') {?>
                ...
                <?php foreach ($informations as $information) { if ($information['information_id']=='8') {?>
                ...
                <!--!link1-->
                 ...
                 <?php foreach ($informations as $information) { if ($information['information_id']=='12') {?>
