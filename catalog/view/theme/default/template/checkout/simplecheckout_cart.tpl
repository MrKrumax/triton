...
<script>
	$(function() {
		$("#buttons").prependTo("#product_related");
	});
</script>
<div class="box simple" id="product_related"style="float:left; clear:both">
  <div class="box-heading">Обратите внимание</div>
  <div class="box-content">
   
    <div id="carousel22">
  <ul class="jcarousel-skin-opencart4">
      <?php $k=0;  foreach ($r_products as $r_product) {
      
             
       $k=$k+1; ?>
      
      <li <? if ($k=='4') echo 'class="last_r"'; ?> >
        <?php if ($r_product['thumb']) { ?>
        <div class="image"><a href="<?php echo $r_product['href']; ?>"><img src="<?php echo $r_product['thumb']; ?>" alt="<?php echo $r_product['name']; ?>" /></a></div>
        <?php } ?>
        <div class="name"><a href="<?php echo $r_product['href']; ?>"><?php echo $r_product['name']; ?></a></div>
        <?php if ($r_product['price']) { ?>
        <div class="price">
          <?php if (!$r_product['special']) { ?>
          <?php echo $r_product['price']; ?>
          <?php } else { ?>
          <span class="price-old"><?php echo $r_product['price']; ?></span> <span class="price-new"><?php echo $r_product['special']; ?></span>
          <?php } ?>
        </div>
        <?php } ?>
        <?php if ($r_product['rating']) { ?>
        <div class="rating"><img src="catalog/view/theme/default/image/stars-<?php echo $r_product['rating']; ?>.png" alt="<?php echo $r_product['reviews']; ?>" /></div>
        <?php } ?>
