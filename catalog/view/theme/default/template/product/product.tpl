...
<div id="content"><?php echo $content_top; ?>
 ...
 <?       } ?>
  ...
  <?php } ?>
    ...
    <div class="note">
        Внимание! Цвет и оттенок изделия на фотографии может отличаться от фактического.<br>
        Комплектация и незначительные характеристики товаров могут быть изменены производителем без уведомления торгующей организации.<br>
        Пожалуйста, перед покупкой обязательно уточняйте интересующие параметры товара у наших консультантов!
    </div>
