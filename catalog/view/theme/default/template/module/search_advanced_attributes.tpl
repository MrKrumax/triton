   ...
   <div class="content">
    ...
    <div id="slider_price" ></div>
     <input name="fp[min]" style="text-align:right; border:none; background:#FFF; float:left" type="text" size="7" /> <input name="fp[max]" style="text-align:left; float:right; border:none; background:#FFF" type="text" size="7" />
