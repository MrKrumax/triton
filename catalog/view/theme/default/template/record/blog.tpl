...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="record-list">
    ...
    <div>
      ...
      <?php } ?>
      <div class="name"><a href="<?php echo $record['href']; ?>" style="font-size: 18px;"><?php echo $record['name']; ?></a></div>
...
<?php if ($record['date_added']) { ?>
  ...
  <div style="clear: both; line-height: 1px; margin-bottom: 5px;  border-bottom: 1px solid #f3f3f3;">&nbsp;</div>
    ...
    <?php } ?>
     ...
     <div class="product-filter dawn blog">
