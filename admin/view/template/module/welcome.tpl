          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="welcome_module[<?php echo $module_row; ?>][position]">
                  ...
                  <?php } ?>
                   <?php if ($module['position'] == 'content_top2') { ?>
                  <option value="content_top2" selected="selected"><?php echo $text_content_top; ?>2</option>
                  <?php } else { ?>
                  <option value="content_top2"><?php echo $text_content_top; ?>2</option>
                  <?php } ?>
...
function addModule() {	
	...
	html += '        <option value="content_top2"><?php echo $text_content_top; ?>2</option>';
