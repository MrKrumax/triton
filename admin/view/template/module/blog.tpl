        ...
        <thead>
          <tr>
            ...
            <td class="left"><?php echo $entry_status; ?></td>
             ...
             <td class="right"><?php echo $entry_razmer_img; ?></td>
            <td class="right"><?php echo $entry_number_blog; ?></td>
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="left"><select name="blog_module[<?php echo $module_row; ?>][status]">
               ...
               <td class="right"><input type="text" name="blog_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" size="3" /></td>
               
               <td class="right"><input type="text" name="blog_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />-<input type="text" name="blog_module[<?php echo $module_row; ?>][height]" value="<?php echo $module['height']; ?>" size="3" /></td>
            
              
            <td class="right"><input type="text" name="blog_module[<?php echo $module_row; ?>][number_blog]" value="<?php echo $module['number_blog']; ?>" size="3" /></td>
...
function addModule() {
    ...
    html += '    </select></td>';
	html += '    <td class="right"><input type="text" name="blog_module[' + module_row + '][limit]" value="" size="3" /></td>';
	html += '    <td class="right"><input type="text" name="blog_module[' + module_row + '][width]" value="" size="3" />-<input type="text" name="blog_module[' + module_row + '][height]" value="" size="3" /></td>';
	
	html += '    <td class="right"><input type="text" name="blog_module[' + module_row + '][number_blog]" value="" size="3" /></td>';
