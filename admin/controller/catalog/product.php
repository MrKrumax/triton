...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
  	...
  	private function getForm() {
		...
		/*video*/
		/*
		if (isset($this->request->post['product_description_video'])) {
			$this->data['product_description_video'] = $this->request->post['product_description_video'];
		} elseif (isset($this->request->get['product_id'])) {
			$this->data['product_description_video'] = $this->model_catalog_product->getProductDescriptions($this->request->get['product_id']);
		} else {
			$this->data['product_description_video'] = array();
		}
		...
		*/
    	...
    	if (isset($this->request->post['information_id'])) {
			...
			$this->data['information_id'] = $product_info['information_id'];
		} else {
